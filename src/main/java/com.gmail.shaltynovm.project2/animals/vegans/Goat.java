...
public class Goat extends Vegans {
    public Goat(FieldInitialization fieldInitialization, int energyCapacity, int givenEnergyIfEaten) {
    ...
    public Animal getNewAnimal(FieldInitialization fieldInitialization) {
        return new Goat(fieldInitialization,5,5);
    }
